export default function Login() {
  const submit = async (e) => {
    ...
    else document.getElementById("err").textContent = "Incorrect passcode.";
  };
  return (
    <div style={{ minHeight:"100vh",background:"#f8fafc",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Inter',system-ui,sans-serif" }}>
      <div style={{ background:"#fff",border:"1.5px solid #e2e8f0",borderRadius:14,padding:"40px 36px",width:320,boxSizing:"border-box" }}>
        ...
        <form onSubmit={submit}>
          ...
          <p id="err" style={{ color:"#ef4444",fontSize:12,margin:"0 0 10px",minHeight:18 }}></p>
          <button type="submit" style={{ width:"100%",padding:"11px",fontSize:13,fontWeight:700,background:"#05828E",color:"#fff",border:"none",borderRadius:8,cursor:"pointer" }}>
            Enter
          </button>
        </form>
      </div>
